...
export const zh_CN: TranslationMap = {
  ...
  usageOverview: {
    ...
    hintCacheHitRate: "Cache 命中率 = cache read / (input + cache read)。越高越好。",
    hintErrorRate: "错误率 = 错误数 / 消息总数。越低越好。",
    hintThroughput: "吞吐量显示活跃时间内的每分钟 Token 数。越高越好。",
    hintAvgTokens: "当前范围内每条消息的平均 Token 数。",
    hintAvgCost: "Provider 报告成本时的每条消息平均成本。",
    hintAvgCostPartial: "Provider 报告成本时的每条消息平均成本。部分会话缺少成本数据。",
